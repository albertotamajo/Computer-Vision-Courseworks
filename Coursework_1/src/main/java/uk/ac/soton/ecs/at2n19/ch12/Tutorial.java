...
public class Tutorial {
    // The performance obtained by this linear classifier is the following:
    // *********************** Overall Results ***********************
    //          Total instances: 75.000
    //            Total correct: 48.000
    //          Total incorrect: 27.000
    //                 Accuracy: 0.640
    //               Error Rate: 0.360
    //   Average Class Accuracy: 0.640
    //   Average Class Error Rate: 0.360
    //
    // ********************** Per Class Results **********************
    // Class	Class Accuracy	Class Error Rate	Actual Count	Predicted Count
    //  accordion	1.000	    0.000	15.000000	25.000000
    //     anchor	0.400	    0.600	15.000000	8.000000
    //  airplanes	1.000	    0.000	15.000000	24.000000
    //        ant	0.267	    0.733	15.000000	5.000000
    // BACKGROUND   0.533	    0.467	15.000000	13.000000
    ...
    // The BagOfVisualWords uses the HardAssigner to assign each Dense SIFT feature to a visual word and the compute the
